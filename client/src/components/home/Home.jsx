...
export default function Home() {
    ...
    return (
        <div className="page-container">
            ...
            <p className="title-p">This is the place where we celebrate our passion for motorcycles!</p>
            <p className="title-p">Our collection features the bikes we've owned, ridden, and loved over the years. From the classic models to the more recent ones, each motorcycle has its own story. Join us as we share memories, adventures, and the joy of two wheels!
